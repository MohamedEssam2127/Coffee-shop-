        ...
        <View className="rounded-t-[32px] bg-white px-6 pb-10 pt-6 shadow-2xl">
          ...
          {success ? (
            <View className="items-center py-10">
              <View className="w-16 h-16 bg-[#FFF5EE] border-2 border-coffee-primary rounded-full items-center justify-center mb-4">
                <Check size={32} color="#C67C4E" />
              </View>
              <Text className="text-[18px] font-bold text-coffee-dark font-sans">
                Added to Cart!
              </Text>
              <Text className="text-[14px] text-gray-400 mt-1 font-sans text-center">
            ...
            <>
              ...
              <View className="flex-row items-center mb-6">
                ...
                <View className="ml-4 flex-1">
                  ...
                  <Text className="text-[12px] text-gray-400 mt-0.5 font-sans">
              ...
              <View className="flex-row justify-between items-center">
                <View>
                  <Text className="text-[12px] text-gray-400 font-sans">Total Price</Text>
